horny = [
  "good girl :3", "Alors comme ca on aime bien se faire attacher ? :smirk:",
  "*te grab par les hanches*", "Je vais devoir régler ca on dirait :smirk:",
  "Aboies pour moi.", "T'es tellement bottom :face_with_hand_over_mouth: ",
  "Tu sais que t'es mignonne quand t'es horny comme ca :3",
